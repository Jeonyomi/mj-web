  ...
  en: {
    ...
    experience: [
      ...
      },
      {
        ...
        tags: ["Ultrasound", "NPI", "Quality", "Global"],
        bullets: [
          "Software Project Leader on NPI ultrasound programs (Voluson series), driving planning and execution across global stakeholders.",
          "Owned SDLC deliverables and documentation (verification, user manual, service manual) across system base/setup, imaging options, and service platform.",
          "Led bug triage and software fixes originating from customer complaints; communicated progress and resolution across teams.",
          "Key programs: Voluson PC400/SC400 (2019–2022), Voluson SPC330/340 (2017–2019).",
        ],
      },
      {
        company: "GE Healthcare",
        ...
        tags: ["Ultrasound", "Imaging", "Quality"],
        bullets: [
          "Developed and maintained software components for Voluson ultrasound systems under SDLC/quality processes.",
          "Contributed to design outputs and documentation (verification and manuals) for imaging (incl. 3D/4D), measurements, and system options.",
          "Collaborated with vendors/platform teams (Congatec COM Express, AMD GPU, Microsoft OS) and manufacturing teams to improve production flows involving software.",
          "Key program: Voluson SPC310 (SW Eng, 2015–2016).",
        ],
      },
      {
        company: "GE Healthcare",
        ...
        tags: ["Manufacturing", "NPI", "Lean", "Quality"],
        bullets: [
          "Drove manufacturing process control and production readiness for regulated medical device programs.",
          "Supported NPI validation, equipment qualification, calibration, and cost reduction activities.",
          "Partnered with manufacturing teams to optimize production steps involving software and platform changes.",
          "Supported audits/quality processes and execution of corrective actions when needed.",
        ],
      },
      {
        company: "Veeco Instruments (Korea)",
        title: "Field Service Engineer — LED MOCVD",
        period: "Jan 2010 – Oct 2011",
        tags: ["Field Service", "MOCVD", "Customer Support"],
        bullets: [
          "Installation and technical support at customer sites such as LG Innotek and Samsung Electronics.",
          "Failure case analysis and failure report preparation.",
          "Reviewed and upgraded equipment improvements.",
          "Demonstration for MOCVD growth operation.",
  ...
  ko: {
    ...
    experience: [
      ...
      },
      {
        company: "GE Healthcare",
        title: "Software Project Leader",
        period: "2017.09 – 2022.05",
        tags: ["Ultrasound", "NPI", "Quality", "Global"],
        bullets: [
          "NPI 초음파(Voluson) 프로그램에서 SW 프로젝트 리더로 기획/실행을 리드하고 글로벌 이해관계자를 조율.",
          "SDLC 기반 산출물(검증, 사용자/서비스 매뉴얼) 및 SW 컴포넌트 문서화를 소유(시스템 베이스/셋업, 옵션, 서비스 플랫폼 등).",
          "고객 불만/필드 이슈 기반 버그 트리아지 및 SW 수정/배포를 리드하고 진행 상황을 커뮤니케이션.",
          "주요 프로그램: Voluson PC400/SC400(2019–2022), Voluson SPC330/340(2017–2019).",
        ],
      },
      {
        company: "GE Healthcare",
        title: "Software Engineer",
        period: "2014.09 – 2017.09",
        tags: ["Ultrasound", "Imaging", "Quality"],
        bullets: [
          "초음파 시스템 SW 컴포넌트 개발/유지보수 및 SDLC/품질 프로세스 기반 개발 수행.",
          "3D/4D, 측정, 옵션 등 Imaging 기능 관련 설계 산출물/문서(검증, 매뉴얼) 작성에 기여.",
          "벤더/플랫폼(Congatec COM Express, AMD GPU, Microsoft OS) 및 제조팀과 협업해 SW 연계 생산 플로우 최적화.",
          "주요 프로그램: Voluson SPC310(SW Eng, 2015–2016).",
        ],
      },
      {
        company: "GE Healthcare",
        ...
        tags: ["Manufacturing", "NPI", "Lean", "Quality"],
        bullets: [
          "공정관리 및 생산 준비(Production readiness) 활동을 수행하고, 규제 환경의 품질 프로세스 기반으로 생산 이슈를 대응.",
          "NPI 검증, 장비 적격성(qualification), 교정(calibration), 원가절감 활동 수행.",
          "플랫폼/소프트웨어 변경이 생산 공정에 미치는 영향 분석 및 제조팀과 협업해 공정 최적화.",
          "감사/품질 이슈 대응 및 필요 시 시정조치(CAPA 등) 지원.",
        ],
      },
      {
        company: "Veeco Instruments (Korea)",
        title: "Field Service Engineer — LED MOCVD",
        period: "2010.01 – 2011.10",
        tags: ["Field Service", "MOCVD", "Customer Support"],
        bullets: [
          "LG이노텍, 삼성전자 등 고객사 현장에서 장비 설치 및 기술 지원 수행.",
          "고장/불량 사례 분석 및 Failure report 작성.",
          "장비 개선 사항 검토 및 업그레이드(개선) 적용.",
          "MOCVD 성장(Growth) 공정 데모 및 운영 지원.",
          "고객 대상 기술 교육(Training) 수행.",
        ],
      },
    ],
    projects: [
